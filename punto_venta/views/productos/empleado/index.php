...
#tabla_productos_busqueda .btn-hover-pink:hover
{
	background-color: #E91E63  ;
	color: white;
}
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		if(pathname=="/punto_venta/views/productos/empleado/")
		{
...
function get_lotes_for_tab_productos()
		...
		function get_all_categorias_productos()
		{
			$.get("../../../core/controllers/controller_admon.php",{action:"get_all_categorias"},function(res)
			{
				...
				$.each(res,function(i,item)
				{
					categorias+='<div class="card cartita_categoria" style="margin:0.1rem; width: 20rem;">'+
									'<ul class="nav navbar-nav navbar-right ">'+
